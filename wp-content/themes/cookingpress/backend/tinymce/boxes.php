                ...
                init : function(ed) {
                    ...
                    jQuery('#selector').change(function(){
                        ...
                        jQuery("#selector option:selected").each(function () {
                           ...
                           var style = $(this).val();
                            jQuery("#demo div").attr('class', 'box-'+style+'-outer');
                            jQuery("#demo div div").attr('class', 'box-'+style);
                          });
                    }).change();
            ...
            <div id="lists">
                    ...
                    <p>
                        <select id="selector">
                            ...
                            <option value="ok">OK box</option>
                            <option value="info">Info Box</option>
                            <option value="question">Notice box</option>
                        </select>
                    </p>
                    <div id="demo">
                        <h3>Box example: </h3>
                            ...
                            <div class="box-error">
                               <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam venenatis, elit eget pulvinar blandit, ligula neque egestas est, ac gravida magna purus eget ligula. Nunc adipiscing, tortor fermentum convallis faucibus, mi justo rhoncus arcu, vulputate pretium arcu leo et nulla. </p>
                            </div>
                        </div>
                    </div>
            </div>

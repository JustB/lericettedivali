...
<div class="container comments clearfix" id="comments">
    <?php if (post_password_required()) : ?>
        <p><?php _e('This post is password protected. Enter the password to view any comments.', 'purepress'); ?></p>
        <?php
    ...
    printf(_n('One Response to %2$s', '%1$s Responses to %2$s', get_comments_number(), 'purepress'), number_format_i18n(get_comments_number()), '' . get_the_title() . '');
        ?></span></h3>

         ...
         <h2 class="entry-title"><a href="<?php the_permalink(); ?>" title="<?php printf(esc_attr__('Permalink to %s', 'purepress'), the_title_attribute('echo=0')); ?>" rel="bookmark"><?php the_title(); ?></a></h2>
             <div class="entry-content">
                        ...
                        if (has_post_thumbnail()) { $words_limit = 18;} else { $words_limit = 50; }
                            ...
                            <?php echo limit_words(get_the_excerpt('Read more &raquo;'), $words_limit);   echo "<a class='read-more' href=".get_permalink()."> read more &rarr;</a>"; ?>
                        <?php else : ?>
                            <?php echo limit_words(get_the_excerpt('Read more &raquo;'), $words_limit);   echo "<a class='read-more' href=".get_permalink()."> read more &rarr;</a>"; endif; ?>
